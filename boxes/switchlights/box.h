...
#define BOXID "Motion Capture-SB-00000"
#define BOX_DEFINITIONS "LGEAR, FLAP0, FLAP1, FLAP2"
#define MAC_ADDRESS 0xC0, 0x90, 0x33, 0x53, 0xB7, 0x99
#define IP_ADDRESS 192, 168, 0, 193
