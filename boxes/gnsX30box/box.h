...
#define BOXID "Motion Capture-GNS430/530-00000"
#define BOX_DEFINITIONS "LED0, LED1, CRSR, DTO, MENU, CLR, ENTER, PROC, FPL, MSG, OBS, CDI"
#define MAC_ADDRESS 0xC0, 0x90, 0x33, 0x53, 0xB8, 0xAE
#define IP_ADDRESS 192, 168, 0, 191
