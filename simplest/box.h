...
#define BOXID "Motion Capture-Simple-TestUnit-00000"
#define BOX_DEFINITIONS "LED0-CI,SWITCH0-CB"
#define IP_ADDRESS 192, 168, 0, 189
#define MAC_ADDRESS 0xC0, 0x90, 0x33, 0x53, 0xB8, 0xDE
